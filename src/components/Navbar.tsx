...
export default function Navbar() {
    ...
    return (
        <header className="sticky top-0 z-50 w-full border-b bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
            <div className="container mx-auto px-4 md:px-8 lg:px-12 flex h-20 items-center justify-center relative">
                {/* Left: Logo - Absolute positioned */}
                <a href="/" className="absolute left-4 md:left-8 lg:left-12 flex items-center gap-2 hover:opacity-80 transition-opacity">
                ...
                <nav className="hidden md:flex items-center justify-center gap-4 lg:gap-8 text-sm font-semibold">
                    {navLinks.map((link) => (
                ...
                {/* Right: CTA & Mobile Toggle - Absolute positioned */}
                <div className="absolute right-4 md:right-8 lg:right-12 flex items-center gap-2 md:gap-4">
